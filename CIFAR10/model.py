...
transform = transforms.Compose([
    transforms.ToTensor(),
    # ((mean), (standard deviation)) <-- precomputed
...
# splits the list into 2 components
split = int(np.floor(valid_size * num_train))
# assigns the 2 components to train and validation
...
# separate into 3 different channels
...
class Net(nn.Module):
    def __init__(self):
        ...
        # 3 in-channels, 16 out-channels, kernal size of 3
        self.conv1 = nn.Conv2d(3, 16, 3, padding=1)
        # 16 in, 32 out, kernal of 3
        self.conv2 = nn.Conv2d(16, 32, 3, padding=1)
        # 32 in, 64 out, kernal of 3
